...
function MyFooter() {
  return (
    ...
    <div className="w-full px-4 lg:px-24">
      ...
      <div className="w-full  bg-gradient-to-tr  from-indigo-200 via-red-200 to-pink-200 px-4 py-6 sm:flex sm:items-center sm:justify-between">
        <Footer.Copyright className='text-black' href="#" by="Suad™" year={2024} />
